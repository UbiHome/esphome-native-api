...
mod tests {
    ...
    use crate::{proto::{version_2025_11_3::HelloRequest}};

    use super::*;

    #[test]
    fn hello_message_short_parse() {
        let bytes = vec![1, 10, 13, 97, 105, 111, 101, 115, 112, 104, 111, 109, 101, 97, 112, 105, 16, 1, 24, 10];
    ...
    fn hello_message_short_serialize() {
        ...
        let message = ProtoMessage::HelloRequest(
            HelloRequest {
                api_version_major: 1,
        ...
        assert_eq!(bytes, vec![1, 10, 13, 97, 105, 111, 101, 115, 112, 104, 111, 109, 101, 97, 112, 105, 16, 1, 24, 10]);
    }
}