...
// use esphome_native_api::{esphomeserver::EspHomeServer, proto::version_2025_6_3::{ListEntitiesBinarySensorResponse, ListEntitiesLightResponse, ListEntitiesSensorResponse, ListEntitiesSwitchResponse, SensorStateResponse}};
