...
async fn main() {
    ...
    let src_output_dir = root_dir.join("src/proto");
    ...
    'outer: loop {
        ...
        for release in &page {
            ...
            // Download source proto options file
            ...
            // Generate proto rust files
            let write_dir = src_output_dir.join(&package_name);
            ...
            // Add to overview of all versions
    ...
    let mod_file = Path::new(&src_output_dir).join("mod.rs");
